...
<body>
    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-main-body content-fluid">
        ...
        <footer class="d-footer">
            <div class="row align-items-center justify-content-between">
                <div class="col-auto">
                    <p class="mb-0">© 2025 Lodgr. All Rights Reserved.</p>
                </div>
                <div class="col-auto">
                    <p class="mb-0">
                        Made by
                        <a href="{{  __('https://kindredghtechnologies.com') }}" class="text-primary-600">
